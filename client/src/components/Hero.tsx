...
const Hero = () => {
  return (
    <div className="relative overflow-hidden bg-gray-800 py-6">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <div>
            <div className="mt-10">
                  ...
                  <div className="flex items-center space-x-6 lg:space-x-8">
                    ...
                    <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      <div className="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          alt=""
                          src="https://images.pexels.com/photos/5864152/pexels-photo-5864152.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                          className="h-full w-full object-cover object-center"
                        />
                      </div>
                      <div className="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          alt=""
                          src="https://images.pexels.com/photos/2643698/pexels-photo-2643698.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                          className="h-full w-full object-cover object-center"
                        />
                      </div>
                    </div>
              ...
              <Link
                to="/market_place"
                className="inline-block rounded-md border border-transparent bg-green-600 px-8 py-3 text-center font-medium text-white hover:bg-green-700 duration-200 ease-in-out"
              >
                Shop Collection
              </Link>
            </div>
